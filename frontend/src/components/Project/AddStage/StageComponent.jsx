...
const StageComponent = ({
  ...
  // Function to handle navigation to AddSubparts page
  const handleAddSubparts = () => {
    navigate('/addSubparts', { state: { stage: stage } }) // Pass stage data as state
  }
  ...
  return (
    ...
    >
      ...
      <button
        className="text-blue-700 ml-4 underline text-sm"
        onClick={handleAddSubparts} // Use onClick to navigate
      >
        +Add Subparts
      </button>
    </div>
